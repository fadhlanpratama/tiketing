...
<head>
    ...
    <title>ESDM - Tiketing - Edit Profil PJ</title>
...
<body class="bg-slate-100/70 min-h-screen font-sans text-slate-800 flex flex-col antialiased">
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div class="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 sm:p-8">
            <form action="{{ route('pj.profile.update') }}" method="POST" class="space-y-8" id="editProfileForm" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="pt-6 border-t border-slate-100 flex items-center justify-end gap-3">
                    <a href="{{ route('pj.dashboard') }}" class="px-6 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-bold transition active:scale-95">
                        Batal
                    </a>
